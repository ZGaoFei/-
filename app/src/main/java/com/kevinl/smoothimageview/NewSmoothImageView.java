...
public class NewSmoothImageView extends AppCompatImageView {
    ...
    public NewSmoothImageView(Context context) {
        super(context);
        init();
    }

    public NewSmoothImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public NewSmoothImageView(Context context, AttributeSet attrs, int defStyle) {
